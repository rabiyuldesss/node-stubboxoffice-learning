...
module.exports = app => {
    ...
    app.get('/legal/privacy', (req, res) => {
        ...
        res.render('pages/legal/privacy', {
            ...
            js,
            home_url,
            header_img: home_url + "/public/img/header/header-img-theatre.jpg",
            bid: process.env.TICKET_NETWORK_WEBCONFIG_BID,
            site_num: process.env.TICKET_NETWORK_WEBCONFIG_SITE_NUMBER,
            url: ''
        });
    });
