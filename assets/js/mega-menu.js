...
$(document).ready(function(){
	...
	$(".menu-container .manu ul li .tabs-dropdown:has(li ul li)").removeClass("have_dropdown").addClass("have_dropdown_n_style");
...
function openCity(evt, cityName) {
	...
	tabcontent = document.getElementsByClassName("list-1");
	for (i = 0; i < tabcontent.length; i++) {
	  tabcontent[i].style.display = "none";
	}
	tablinks = document.getElementsByClassName("t-list1");
...
// 	var i, tabcontent, tablinks;
// 	tabcontent = document.getElementsByClassName("list");
// 	for (i = 0; i < tabcontent.length; i++) {
// 	  tabcontent[i].style.display = "none";
// 	}
// 	tablinks = document.getElementsByClassName("t-list");
// 	for (i = 0; i < tablinks.length; i++) {
// 	  tablinks[i].className = tablinks[i].className.replace(" active", "");
// 	}
// 	document.getElementById(cityName).style.display = "block";
